...
import { n as authEnabled, o as signOut } from "./client-BPhGxWc7.mjs";
...
import { t as Route$9 } from "./facturas._id-Cntzual5.mjs";
import { i as isHoyItem } from "./priority-CmdkFfTm.mjs";
import { t as auth } from "./server-B7bcSJte.mjs";
import { i as useCurrentUserState, n as isDemoModeActive, r as useCurrentUser } from "./demo-login-OpmkJEKI.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-JKlZL5-C.js
...
function RedirectToSignIn({ to = SIGN_IN_PATH }) {
	if (!authEnabled) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Navigate, { to: "/" });
...
function UserButton() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			authEnabled && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				type: "button",
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
				...
				children: [
					...
					!authEnabled && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mx-3 mt-3 flex items-center gap-2 rounded-lg bg-warn/25 px-3 py-2 text-xs font-semibold text-sidebar-fg",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FlaskConical, { className: "size-3.5 shrink-0" }), "Acceso abierto (sin login)"]
					}),
					demoMode && authEnabled && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mx-3 mt-3 flex items-center gap-2 rounded-lg bg-warn/25 px-3 py-2 text-xs font-semibold text-sidebar-fg",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					!authEnabled && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FlaskConical, { className: "size-3.5 shrink-0" }), "Acceso abierto temporal — auth desactivada (VITE_AUTH_ENABLED=false)"]
					}),
					demoMode && authEnabled && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center justify-center gap-2 bg-warn px-3 py-1.5 text-center text-xs font-semibold text-white",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
						...
						children: [
							...
							!authEnabled && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "hidden items-center gap-1 rounded-full bg-warn-bg px-2.5 py-1 text-[11px] font-semibold text-warn sm:inline-flex",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FlaskConical, { className: "size-3" }), "Acceso abierto"]
							}),
							demoMode && authEnabled && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "hidden items-center gap-1 rounded-full bg-warn-bg px-2.5 py-1 text-[11px] font-semibold text-warn sm:inline-flex",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FlaskConical, { className: "size-3" }), "Demo"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "shrink-0",
								children: isPending ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-8 w-8 animate-pulse rounded-full bg-surface-2" }) : user ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserButton, {}) : authEnabled ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									to: "/login",
...
var $$splitComponentImporter$6 = () => import("./routes-DYnNAKLh.mjs");
var Route$7 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./configuracion-BbTykZia.mjs");
