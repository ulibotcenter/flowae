...
import { a as signIn, n as authEnabled, t as authClient } from "./client-BPhGxWc7.mjs";
...
import { i as GROK_PROVIDERS } from "./server-B7bcSJte.mjs";
import { i as useCurrentUserState, t as enterDemoMode } from "./demo-login-OpmkJEKI.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-sSec1ovy.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
				...
				children: [
					...
					authEnabled ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						demoEnabled && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: "El inicio de sesión está desactivado en este entorno."
					}),
					error && !authEnabled && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "rounded-md bg-danger-bg px-3 py-2 text-xs text-danger",
						children: error
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
