...
import { t as authMiddleware } from "./middleware-C12ZL9lq.mjs";
import { s as getSql } from "./db-m21Nw3rD.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/server-fn--6eJ8pb8.js
var empty = () => ({
	clientName: "",
	clientEmail: "",
	clientNif: "",
...
*/
function masterKey() {
	const preferred = typeof process !== "undefined" ? process.env.SECRETS_ENCRYPTION_KEY?.trim() : void 0;
	const fallback = typeof process !== "undefined" ? process.env.BETTER_AUTH_SECRET?.trim() : void 0;
	const raw = preferred || fallback || "facturaflow-dev-only-secrets-key";
