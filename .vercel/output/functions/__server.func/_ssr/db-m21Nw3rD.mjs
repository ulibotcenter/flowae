...
//#region node_modules/.nitro/vite/services/ssr/assets/db-m21Nw3rD.js
var db_m21Nw3rD_exports = /* @__PURE__ */ __exportAll({
	a: () => getPglite,
	c: () => DATABASE_REQUIRED_MESSAGE,
	i: () => getDatabaseConfigError,
	n: () => db_exports,
	o: () => getSql,
	r: () => ensureDbReady,
	s: () => isPgliteAllowed,
...
*/
var DATABASE_REQUIRED_MESSAGE = "Falta configurar DATABASE_URL (Postgres). Contacta al administrador del despliegue.";
var db_exports = /* @__PURE__ */ __exportAll$1({
	DATABASE_REQUIRED_MESSAGE: () => DATABASE_REQUIRED_MESSAGE,
	dbSource: () => dbSource,
	ensureDbReady: () => ensureDbReady,
	getDatabaseConfigError: () => getDatabaseConfigError,
	getPglite: () => getPglite,
	getSql: () => getSql,
	isPgliteAllowed: () => isPgliteAllowed
});
...
*/
var dbSource = databaseUrl ? "neon" : isPgliteAllowed() ? "pglite" : "unconfigured";
...
async function createPgliteSql() {
	if (!isPgliteAllowed()) throw new Error(DATABASE_REQUIRED_MESSAGE);
...
async function createSql() {
	...
	if (dbSource === "unconfigured") throw new Error(DATABASE_REQUIRED_MESSAGE);
...
//#endregion
export { getDatabaseConfigError as a, isPgliteAllowed as c, ensureDbReady as i, dbSource as n, getPglite as o, db_m21Nw3rD_exports as r, getSql as s, DATABASE_REQUIRED_MESSAGE as t };
